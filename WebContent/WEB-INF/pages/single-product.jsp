...
<!-- Bootstrap -->
<link rel="stylesheet"
	href="<linkc:url value="/css/bootstrap.min.css"/>">

<!-- Font Awesome -->
<link rel="stylesheet"
	href="<linkc:url value="/css/font-awesome.min.css"/>">
			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="/HardwareStore/product">Single
								product</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="product-images">
									<div class="product-main-img">
										<img src="img/Indoor/Image${single.nameId}.jpg" alt="">
									</div>
							...
							<div class="col-sm-6">
								<div class="product-inner">
									<h2 class="product-name">${single.modelName}</h2>
									<div class="product-inner-price">
										<ins>${single.cost}</ins>
										<del>${single.cost}+25</del>
									</div>
                    ...
                    <c:forEach items="${single.productList}" var="item">
								<div class="single-product">
									<div class="product-f-image">
										<img
											src="img/Indoor/Image${item.nameId}.jpg"
											alt="">
										<div class="product-hover">
											<a href="" class="add-to-cart-link"><i
												class="fa fa-shopping-cart"></i> Add to cart</a> <a
												href="/HardwareStore/product?name=${item.modelName }"
